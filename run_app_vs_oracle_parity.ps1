# sentinel:skip-file — hardcoded Python interpreter path is a
# Task-Scheduler-PATH workaround per lessons.md 2026-04-30
# (`Execute='python'` fails silently from system-account context).
# Same convention as C:/overmind/scripts/nightly_verify.bat.
param(

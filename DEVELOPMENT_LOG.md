<!-- sentinel:skip-file — operator-facing reference doc citing local
     console commands and `C:/Users/user/...` paths as part of the
     workflow, not application configuration. Same pattern as
